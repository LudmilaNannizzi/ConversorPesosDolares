function cambiarDolares() {
    ...
    if(resultado<=0){
        ...
        alert('$'+ ingresoPesos+ ' pesos argentinos son US$'+resultado + '. El impuesto país es de $' + impuestoPais + ' y las retenciones equivalen a $'+ retencionGanancias+' pesos argentinos. El total a pagar es de $'+ valorReal)
    }
